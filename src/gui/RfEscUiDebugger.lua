...
local function _getSoilModDirectory()
    ...
    if (IncomeModModName or g_currentModName) == SOIL_MOD_NAME and (IncomeModModDirectory or g_currentModDirectory) ~= nil then
        return (IncomeModModDirectory or g_currentModDirectory)
    end
...
local function _getXmlPath()
    ...
    if (IncomeModModDirectory or g_currentModDirectory) ~= nil then
        return (IncomeModModDirectory or g_currentModDirectory) .. "xml/gui/" .. CLASS_NAME .. ".xml"
    end
    return nil
end
...
local function _getProfilesXml()
    ...
    return _profilesCandidate((IncomeModModDirectory or g_currentModDirectory))
end
...
function RfEscUiDebugger.install()
    ...
    local soilDir = _getSoilModDirectory()
    local myDir = (IncomeModModDirectory or g_currentModDirectory)
    ...
    local owner = ((IncomeModModName or g_currentModName) ~= nil and (IncomeModModName or g_currentModName)) or "unknown"
