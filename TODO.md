...
- [x] Esc framework table freeze (Income guest, #49): shared grid restated per show; 2.1.7.34.
- [~] In-game: Income table keeps its columns after visiting another Esc guest in the same session.
